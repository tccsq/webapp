...
function addUser(){
	...
	window.location = "user/addUser?id="+personId;
}
function updateUser(){
	var anSelected = fnGetSelected( oTable );
	...
	window.location = "user/updateUser?id="+personId;
}
...
function deleteUser(){
	...
	//window.location = "system/user!delete.action?id="+personId;
	//获得被选中记录的ID
	var personId = anSelected[0].children[0].innerHTML;
	$.get("user/delUser?id"+personId,function(){
...
<table id="personList" class="display" width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
	<thead>
      <tr>
        ...
        <th width="60" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">名称</span></div></th>
        <th width="25" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">岗位/部门</span></div></th>
        <th width="50" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">登录名</span></div></th>
      </tr>
    </thead>
    <tbody>
    	<tr>
